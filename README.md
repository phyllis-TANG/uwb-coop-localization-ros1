...
Melodic. Those workspaces must remain untouched. The next gate is to initialize
and build this repository's independent `ros_ws` workspace by following
[`docs/workspace_setup.md`](docs/workspace_setup.md). Package creation remains a
separate step after that clean workspace build succeeds.
